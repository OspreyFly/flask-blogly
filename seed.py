from models import Person, Post, db
from app import app
...
with app.app_context():
    ...
    person1 = Person(first_name="Noah", last_name="Goff", img_url="https://wp.technologyreview.com/wp-content/uploads/2022/12/E8G1GY.jpeg")
    person2 = Person(first_name="Oliver", last_name="Goff", img_url="https://icatcare.org/app/uploads/2018/07/Thinking-of-getting-a-cat.png")
